...
export const llmHosts: LLMHost[] = [
  {
    ...
    models: mapModels(CLAUDE2, CODE_LLAMA2_34B, LLAMA2_13B, LLAMA2_70B, GPT_35_TURBO, GPT_35_TURBO_16K, GPT_4, GPT_4_32K, PALM2, PALM2_CODE, HERMES_LLAMA2_13B, AIROBOROS_70B)
  },
  {
    url: "https://api.endpoints.anyscale.com/v1",
    models: mapModels(LLAMA2_7B_AS, LLAMA2_13B_AS, LLAMA2_70B_AS, CODE_LLAMA2_34B_AS)
  },
]
