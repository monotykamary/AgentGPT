...
export const GPT_MODEL_NAMES = [CLAUDE2, CODE_LLAMA2_34B, LLAMA2_13B, LLAMA2_70B, GPT_35_TURBO, GPT_35_TURBO_16K, GPT_4];
export type GPTModelNames = "anthropic/claude-2" | "meta-llama/codellama-34b-instruct" | "meta-llama/llama-2-13b-chat" | "meta-llama/llama-2-70b-chat" | "openai/gpt-3.5-turbo" | "openai/gpt-3.5-turbo-16k" | "openai/gpt-4" |"google/palm-2-chat-bison" | "google/palm-2-codechat-bison" | "nousresearch/nous-hermes-llama2-13b";
