...
class OpenAIAgentService(AgentService):
    ...
    async def analyze_task_agent(
        ...
        if 'llama' in self.model.model_name:
           ...
           completionDict = function_call.get('arguments')
           completion = json.dumps(completionDict)
    ...
    async def summarize_task_agent(
        ...
        *,
        ...
        self.model.model_name = "openai/gpt-3.5-turbo"
        self.model.max_tokens = 4000  # Total tokens = prompt tokens + completion tokens
